...
public class DataLoader implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) {
        ...
        Image image6_1 = new Image("https://a0.muscache.com/im/pictures/16fd05e4-1b74-44ab-8fb4-793f378bcd59.jpg?im_w=960", property11);
        imageRepository.save(image6_1);
        Image image6_2 = new Image("https://a0.muscache.com/im/pictures/f2106a3a-6e90-4660-9e4f-dfc2b3035865.jpg?im_w=720", property11);
        imageRepository.save(image6_2);
        Image image6_3 = new Image("https://a0.muscache.com/im/pictures/8b116b5d-ba7a-41c2-bcf7-e5349002cff7.jpg?im_w=1200", property11);
        imageRepository.save(image6_3);

        Property propert7 = new Property(host1, "Glasgow", 900, "A turreted castle in Glasgow city centre!! Six beautiful and luxurious bedroom suites, 5 roaring fireplaces and Rugby pitch in back garden.", PropertyType.MANSION);
        propertyRepository.save(property7);
        Image image7_1 = new Image("https://a0.muscache.com/im/pictures/miso/Hosting-52841116/original/407b37cb-1f5d-4566-9982-f7535c22ee20.jpeg?im_w=960", property12);
        imageRepository.save(image7_1);
        Image image7_2 = new Image("https://a0.muscache.com/im/pictures/miso/Hosting-52841116/original/0b9dc45f-6a66-4606-a10a-c4752332998c.png?im_w=720", property12);
        imageRepository.save(image7_2);
        Image image7_3 = new Image("https://a0.muscache.com/im/pictures/3abc29b2-895e-471e-b7d2-ed97bdd76b58.jpg?im_w=1200", property12);
        ...
        Image image8_1 = new Image("https://a0.muscache.com/im/pictures/miso/Hosting-51907131/original/7a486bca-f1b2-498e-a2e0-b1ddabc6ed0f.jpeg?im_w=1200", property13);
        imageRepository.save(image8_1);
        Image image8_2 = new Image("https://a0.muscache.com/im/pictures/miso/Hosting-51907131/original/ca7d2f91-a802-4cbc-8812-17ed5d423703.jpeg?im_w=1200", property13);
        imageRepository.save(image8_2);
        Image image8_3 = new Image("https://a0.muscache.com/im/pictures/miso/Hosting-51907131/original/e8342ee2-cb35-496e-966d-a734cc98b324.jpeg?im_w=1200", property13);
        ...
        Image image9_1 = new Image("https://a0.muscache.com/im/pictures/miso/Hosting-50603897/original/d1b5ba09-72aa-49d2-9cd7-8a8d4ef391ca.jpeg?im_w=960", property14);
        imageRepository.save(image9_1);
        Image image9_2 = new Image("https://a0.muscache.com/im/pictures/f6d0f7ce-464d-4931-b0c8-669b5b6d1cd4.jpg?im_w=720", property14);
        imageRepository.save(image9_2);
        Image image9_3 = new Image("https://a0.muscache.com/im/pictures/miso/Hosting-50603897/original/f129f06f-67be-484e-abc1-747d915e3d2f.jpeg?im_w=720", property14);
        ...
        Image image10_1 = new Image("https://a0.muscache.com/im/pictures/9a70f62b-decf-4b50-9a18-1dd7e4d672e2.jpg?im_w=960", property15);
        imageRepository.save(image10_1);
        Image image10_2 = new Image("https://a0.muscache.com/im/pictures/b5da27eb-c528-43e1-a5ed-bba96ff1939a.jpg?im_w=1200", property15);
        imageRepository.save(image10_2);
        Image image10_3 = new Image("https://a0.muscache.com/im/pictures/5cb31202-8640-48f5-be56-9f9b07d51de2.jpg?im_w=720", property15);
